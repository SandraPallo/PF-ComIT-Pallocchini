...
<html>
  ...
  <body id="formpedido">
	...
	<form id="pedido" action="php/enviarpedido.php" method="post" >
			...
			<div id="contenedor" class="fluid row">	
				...
				<div id="sectorcentral" class="col-sm-12">
					...
					<label>CUIG</label>
					<input id="cuig" class="mr-sm-2" type="textinput" name="cuig" required placeholder="XX999" pattern="[A-Z]{2}[0-9]{3}" ></input>
	...
	<form  action="php/busqueda.php" method="post">
					...
					--> <input  id="id_vet" name="id_vet"  type="text" size="1" class="inputvet" VALUE="<?php echo $userId ?>" >Num.CLiente</input>
